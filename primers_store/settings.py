"""
Django settings for primers_store project.
...
# Initialize environ
env = environ.Env()
env_file = os.environ.get('ENV_FILE', '.env')  # Default to '.env' if ENV_FILE is not set
...
ROOT_URLCONF = 'primers_store.urls'
...
WSGI_APPLICATION = 'primers_store.wsgi.application'
